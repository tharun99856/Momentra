...
const MOCK_MEMBERS = [
  { id: '1', username: '', email: '', role: 'admin' as const, joinedAt: new Date().toISOString() },
]
...
export default function SettingsPage() {
  ...
  const currentMember = { ...MOCK_MEMBERS[0], username: user?.username ?? '', email: user?.email ?? '' }
        ...
        <div className={styles.tabContent}>
              ...
              <div className={styles.dangerZone}>
                ...
                <div className={styles.dangerCard}>
                  <div>
                    ...
                    <p className={styles.dangerDesc}>Permanently delete this workspace and all its data.</p>
                  </div>
          ...
          {activeTab === 'team' && (
            <div className={styles.panel}>
              ...
              {inviteSent && (
                <p className={styles.inviteSuccess}>Invitation sent!</p>
              )}
              ...
              <div className={styles.memberList}>
                <div className={styles.memberRow}>
                  ...
                  <div className={styles.memberInfo}>
                    <span className={styles.memberName}>{currentMember.username}</span>
                    <span className={styles.memberEmail}>{currentMember.email}</span>
                  </div>
                  <span className={styles.roleBadge}>{currentMember.role}</span>
              ...
              <div className={styles.inviteLinkBox}>
                ...
                <div className={styles.inviteLinkRow}>
                  <code className={styles.inviteLinkCode}>https://momentra.app/join/abc123</code>
            ...
            <div className={styles.panel}>
              ...
              <div className={styles.usageGrid}>
                ...
                <div className={styles.usageItem}>
                  ...
                  <div className={styles.usageBar}>
                    <div className={styles.usageFill} style={{ width: '33%' }} />
                  </div>
                </div>
                <div className={styles.usageItem}>
                  <div className={styles.usageHeader}>
              ...
              <div className={styles.plansGrid}>
                {PLANS.map((plan) => (
                  <div key={plan.id} className={`${styles.planCard} ${plan.current ? styles.planCardCurrent : ''}`}>
                    ...
                    {plan.current ? (
                      <span className={styles.planCardBadge}>Current</span>
                    ) : (
                      <button type="button" className={styles.planCardBtn}>
          ...
          {activeTab === 'api' && (
            <div className={styles.panel}>
              ...
              <div className={styles.apiSection}>
                ...
                <div className={styles.apiKeyRow}>
                  <code className={styles.apiKeyCode}>
                    {apiKeyVisible ? mockApiKey : 'mk_live_' + '•'.repeat(32)}
                  </code>
                  <button
                    type="button"
              ...
              <div className={styles.apiSection}>
                ...
                <input
                  type="url"
                  placeholder="https://your-app.com/webhooks/momentra"
                  className={styles.input}
                />
                <p className={styles.apiHint}>
                  We'll send POST requests here when events happen (uploads, comments, etc.).
                </p>
              </div>

              <div className={styles.apiDocs}>
                <h3 className={styles.apiLabel}>Documentation</h3>
                <p className={styles.apiDocsText}>
                  Check out our API docs to learn how to upload photos, manage events, and query galleries programmatically.
                </p>
