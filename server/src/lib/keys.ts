...
export function getKeyPair(): KeyPair {
  ...
  if (!privateKeyB64) {
    throw new ConfigurationError('JWT_PRIVATE_KEY environment variable is not set')
  }
  if (!publicKeyB64) {
    throw new ConfigurationError('JWT_PUBLIC_KEY environment variable is not set')
  }
