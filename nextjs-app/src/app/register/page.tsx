        ...
        <div className={styles.card}>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <div className={styles.field}>
              ...
              <input id="username" type="text" value={username} onChange={(e) => setUsername(e.target.value)} required className={styles.input} placeholder="your_handle" autoComplete="username" />
            ...
            <div className={styles.field}>
              ...
              <input id="password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required className={styles.input} placeholder="At least 8 characters" autoComplete="new-password" />
              {errors.password && <span className={styles.fieldError}>{errors.password}</span>}
            </div>
            <button type="submit" disabled={loading} className={styles.button}>
              {loading ? 'Creating account…' : 'Create account'}
            </button>
            <p className={styles.link}>Already a member? <Link href="/login">Sign in</Link></p>
          </form>
        </div>
      </main>
    </div>
